...
def main_batik(username, password, start_date, end_date):
    ...
    try:
       ...
       'PK-BKP', 'PK-BKT', 'PK-BKU', 'PK-BKV', 'PK-BLC', 'PK-BLD']
        ...
        for fid in batik:
            ...
            scrape_flight_history(driver, "ID", fid, start, end)
        logging.info("Batik flight history scraping completed successfully.")
    finally:
