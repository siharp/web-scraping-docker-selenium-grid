...
def login_to_flightradar(driver, username, password):
    try:
        ...
        time.sleep(3)  # Tambahkan jeda untuk memastikan elemen sudah siap
        login_button.click()
...
def main_saj(username, password, start_date, end_date):
    ...
    try:
       ...
       'PK-STI', 'PK-STA', 'PK-STQ', 'PK-SJQ', 'PK-SJK', 'PK-STT']
        ...
        for fiu in saj:
            ...
            scrape_flight_history(driver, "IU", fiu, start, end)
        logging.info("SAJ flight history scraping completed successfully.")
